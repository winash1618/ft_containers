...
template <class _V, class Alloc>
ft::__const_tree_iterator<_V, Alloc>::__const_tree_iterator(const ft::__const_tree_iterator<_V, Alloc>& src)
{
	*this = src;
	return;
}
...
ft::__const_tree_iterator<_V, Alloc>::operator=(const ft::__const_tree_iterator<_V, Alloc>& x)
{
	if (this != &x)
	{
		__iter = x.__iter;
