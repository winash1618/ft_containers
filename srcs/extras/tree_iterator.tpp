...
template <class _V, class Alloc>
ft::__tree_iterator<_V, Alloc>::__tree_iterator(const ft::__tree_iterator<_V, Alloc>& src)
{
	*this = src;
	return;
}
...
ft::__tree_iterator<_V, Alloc>::operator=(const ft::__tree_iterator<_V, Alloc>& x)
{
	if (this != &x)
	{
		__ptr_ = x.__ptr_;
