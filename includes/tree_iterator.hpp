...
namespace ft
{
	...
	class __const_tree_iterator
	{
		public:
			...
			// __const_tree_iterator& operator=(const __const_tree_iterator<_V, _NodePtr>& __u) // commented for linux working fine in mac
			// { 
			// 	if (this != &__u) 
			// 	{
			// 		__ptr_ = static_cast<__const_tree_iterator<_V, _NodePtr> >(__u.__ptr_);
			// 		__end_ = static_cast<__const_tree_iterator<_V, _NodePtr> >(__u.__end_);
			// 	}
			// 	return *this;
			// }
			reference operator*() const
