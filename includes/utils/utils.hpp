...
/*   Updated: 2022/12/18 08:17:17 by mkaruvan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	bool tree_is_left_child(_NodePtr current_node, _NodePtr nil)
	{
		if (current_node != nil )
	...
	template <class _NodePtr>
	_NodePtr tree_min(_NodePtr current_node, _NodePtr nil)
	{
	...
	template <class _NodePtr>
	_NodePtr tree_max(_NodePtr current_node, _NodePtr nil)
	{
