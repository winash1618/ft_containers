...
/*   Updated: 2022/12/05 15:55:07 by mkaruvan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class iterator 
	{
		...
		public:
			...
			iterator& operator--() {--__i; return *this;}
			iterator  operator--(int) {iterator __tmp(*this); --(*this); return __tmp;}
			iterator  operator+ (difference_type __n) const {iterator __w(*this); __w += __n; return __w;}
			iterator& operator+=(difference_type __n) {__i += __n; return *this;}
